 ...
 */
  ...
  [_BASE] = LAYOUT_60_ansi_split_space_rshift(
    ...
    KC_LCTL, TD_LGUI, TD_LALT,          KC_BSPC, MO(1),   KC_SPC,           TD_LALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
  ),
 ...
 */
  ...
  [_RAISE] = LAYOUT_60_ansi_split_space_rshift(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, KC_MAKE,
    _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
