...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_VIM] = LAYOUT_base_wrapper(
    _______________________VIM_L1_______________________, _______________________VIM_R1_______________________,
    _______________________VIM_L2_______________________, _______________________VIM_R2_______________________,
    _______________________VIM_L3_______________________, _______________________VIM_R3_______________________
  ),
