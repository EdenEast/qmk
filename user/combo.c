...
const uint16_t PROGMEM lui_lum_combo[]     = {LUI, LUM,  COMBO_END};
const uint16_t PROGMEM lli_llp_combo[]     = {LLI, LLP,  COMBO_END};
const uint16_t PROGMEM lli_llm_combo[]     = {LLI, LLM,  COMBO_END};
...
const uint16_t PROGMEM rui_rum_combo[]     = {RUI, RUM,  COMBO_END};
const uint16_t PROGMEM rli_rlp_combo[]     = {RLI, RLP,  COMBO_END};
const uint16_t PROGMEM rli_rlm_combo[]     = {RLI, RLM,  COMBO_END};
