...
#define ________________SYM_R1_________________________ _______,_______,_______,_______,_______,RESET
...
#define ________________FN_R1__________________________ _______,_______,_______,_______,_______,RESET
