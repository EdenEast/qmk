...
[_NUM] = LAYOUT_5x6(
    ...
    _______,KC_GRV ,KC_1   ,KC_2   ,KC_3   ,KC_BSLS,                        _______,_______,_______,_______,DF_NUM ,_______, \
                    _______,_______,                                                        _______,_______,                 \
...
[_SYM] = LAYOUT_5x6(
    ...
    _______,KC_TILD,KC_EXLM,KC_AT  ,KC_HASH,KC_PIPE,                        _______,_______,_______,_______,DF_SYM ,_______, \
                    _______,_______,                                                        _______,_______,                 \
...
[_FN] = LAYOUT_5x6(
    ...
    _______,KC_F12 ,KC_F7  ,KC_F8  ,KC_F9  ,KC_SLCK,                        _______,_______,_______,_______,_______,_______, \
    _______,KC_F11 ,KC_F4  ,KC_F5  ,KC_F6  ,KC_PSCR,                        _______,KC_LCTL,KC_LSFT,KC_LALT,KC_LGUI,_______, \
    KC_PWR ,KC_F10 ,KC_F1  ,KC_F2  ,KC_F3  ,KC_PAUS,                        _______,_______,_______,_______,DF_FN  ,_______, \
                    _______,_______,                                                        _______,_______,                 \
...
[_NAV] = LAYOUT_5x6(
    ...
    _______,DF_NAV  ,_______,_______,_______,_______,                        KC_HOME,KC_PGDN,KC_PGUP,KC_END ,KC_INS,_______, \
...
[_MOUSE] = LAYOUT_5x6(
    ...
    _______,DF_MOUS,_______,_______,_______,_______,                        KC_WH_L,KC_WH_D,KC_WH_U,KC_WH_R,_______,_______, \
                    QRTY_TO,CLMK_TO,                                                        _______,_______,                 \
...
[_MEDIA] = LAYOUT_5x6(
    ...
    _______,DF_MDIA,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______, \
                    QRTY_TO,CLMK_TO,                                                        _______,_______,                 \
